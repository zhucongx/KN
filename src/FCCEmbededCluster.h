...
struct occupInfo_256 {
  ...
  std::vector<std::vector<std::pair<int, int>>> jumpPairs;
  occupInfo_256() {
    mapping = std::vector<std::vector<int >>(6, std::vector<int>(256, 0));
    ...
    for (int i : {3, 19, 2, 18, 7, 23, 6, 22, 67, 83, 66, 82, 71, 87, 70, 86})
      mapping[0][i] = 2;
    jumpPairs.emplace_back(std::vector<std::pair<int, int >>({{82, 83},
                                                              {82, 80},
                                                              {82, 148},
                                                              {83, 160},
                                                              {83, 81},
    ...
    for (int i : {0, 1, 20, 21, 40, 4, 5, 24,
      ...
      mapping[3][i] = 2;
    jumpPairs.emplace_back(std::vector<std::pair<int, int >>({{84, 65},
                                                              {84, 87},
                                                              {148, 151},
                                                              {148, 135},
                                                              {148, 87},
